...
if DEBUG:
    # use corsheaders in debuh mode only
...
OPTIMIZER_QUEUE_NAME = 'optimizer'
...
RQ_QUEUES[OPTIMIZER_QUEUE_NAME] = {
    'USE_REDIS_CACHE': 'default',
}
...
if TESTING:
    ...
    DJANGO_REDIS_CONNECTION_FACTORY = "webapp.settings.FakeConnectionFactory"
